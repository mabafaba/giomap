...
class Giomap {
    ...
    addEditPropertiesPopupToLayer (somelayer){      
        // this whole portion is a little convoluted:
        ...
        // it is passed to the mapio instance as a callback for the 'newFeature' event, 
        // because mapio handles all incoming features (drawn, live received or downloaded from server history),
        ...
        // so refactoring this part to get rid of the nested function definitions will cause PROBLEMS <3 good luck!
        ...
        somelayer.on('popupopen', function(e) {
            ...
            const typologySelector = new TypologySelector(giomap.typologies, onsubmit = submitPopupForm);
